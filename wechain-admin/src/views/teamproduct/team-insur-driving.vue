        ...
        <Form ref="formValidate" :model="formInline" :rules="ruleValidate" :label-width="120">
            <Card>
                ...
                <Row>
                    <Col span="8">
                    <span>选择方案:</span>
                    <Select class="category-select"  v-model="formInline.category" style="width: 260px" @on-change="selectProductChange($event)">
    ...
    export default {
        ...
        methods: {
            ...
            count () {
                ...
                if( this.tableData == '' ){
                    this.$Message.warning('请上传被保险人,被保险人不能为空');
                    return false;
                }
...
//                }
                ...
                let price;
                if( this.formInline.category == 'TEST001A' ){
                    price = 125
                }else{
                    price = 220
                }
                let num = this.tableData.length;
                this.premium = price * num;
            },
            ...
            handleSubmit (names){
                this.$refs[names].validate((valid) => {
                    if (valid) {
                        ...
                        json.sign = md5("account"+"DriverSchool"+"data"+json.data+"reqTid"+json.reqTid+"74!jgj^%sairet58d&4").toString().toUpperCase()
                        let url = 'http://192.168.1.28:8765/insurance/driverSchIns/apply';
                        let urlImg = 'http://192.168.1.28:8765/insurance/driverSchIns/wexin/pay/jhqr';
                        this.$Spin.show();
...
//                                    console.log(tupian)
        ...
        mounted () {
            ...
            this.$http.post(url,{'productNo': "JHTECHTEST001"}).then(response => {
